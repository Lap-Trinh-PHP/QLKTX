...
<div class="col-md-12">
    <div style="margin-bottom:5px;">
        <a href="index.php?page=ThemSuaTrucTQ&action=add" class="btn btn-primary">Thêm</a>
    </div>
                    ...
                    while($row = mysqli_fetch_assoc($result)){
                        ...
                        echo "<tr>
                            ...
                            <td  style='text-align:center;max-width:70px;'>
                                <a class='btn btn-info' href='index.php?page=ThemSuaTrucTQ&action=edit&id=".$row["idTruc"]."'>Edit</a>&nbsp;
                                <a class='btn btn-danger' href='index.php?page=ThemSuaTrucTQ&action=delete&id=".$row["idTruc"]."'>Delete</a>
                            </td>
                        </tr>";
                    };
                    mysqli_close($conn);
